...
*sub01: never confident before non-overlapping segment. *

*Excluding subject 01 and 03*

```{r}
prescan_batch = prescan_batch %>% filter(sub != '01' & sub != '03')
scan_batch = scan_batch %>% filter(sub != '01' & sub != '03')
postscan_batch = postscan_batch %>% filter(sub != '01' & sub != '03')
```
