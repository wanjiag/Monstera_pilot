...
```{r}
prescan_batch = prescan_batch %>% filter(sub != '05' & sub != '14' & sub != '08')
scan_batch = scan_batch %>% filter(sub != '05' & sub != '14' & sub != '08')
postscan_batch = postscan_batch %>% filter(sub != '05' & sub != '14' & sub != '08')
```
