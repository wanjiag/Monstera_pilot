...
*Excluding subject 05, 08, 14, 15, and 16. Should we exclude sub 08?*

*Notice: sub1/3/7 have very low confidence.*


```{r}
prescan_batch = prescan_batch %>% filter(sub != '05' & sub != '14' & sub != '15' & sub != '16')
scan_batch = scan_batch %>% filter(sub != '05' & sub != '14' & sub != '15' & sub != '16')
postscan_batch = postscan_batch %>% filter(sub != '05' & sub != '14' & sub != '15' & sub != '16')
```
